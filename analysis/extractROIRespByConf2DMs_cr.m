function [conf_C, conf_A, conf_Y, conf_N] = extractROIRespByConf2DMs_cr(project_params,which_subjects,coordinates, ROI_name)
...
if ~strcmp(ROI_name, 'dontSaveMe')
    save(fullfile(p.stats_dir,'DM431555','group',ROI_name),...
    'conf_C','conf_A','conf_Y','conf_N')

    save(fullfile(p.stats_dir,'DM432555','group',ROI_name),...
        'conf_C','conf_A','conf_Y','conf_N')
end
end