function extractROIRespByConfByAcc2DMs(project_params,which_subjects,coordinates, ROI_name)
...
[conf_CC, conf_AC, conf_YN, conf_NN, conf_CA, conf_AA, conf_YY, conf_NY] =...
    deal(nan(numel(which_subjects),6));
...
save(fullfile(p.stats_dir,'DM434','group',ROI_name),...
    'conf_CC','conf_AA','conf_YY','conf_NN',...
    'conf_CA','conf_AC','conf_YN','conf_NY')
end